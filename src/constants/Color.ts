...
const Colors = {
    background_for_button: '#333333', // nền cho nút (xám mờ)
    ...
    white_button: '#FFFFFF', // nút trắng
    gray_button: '#4E4E4E', // nút xám
    error_text: '#FF0000', // màu chữ đỏ
    link: '#C7C4BF', // màu chữ xám nhạt
